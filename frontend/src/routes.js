...
import InvoiceTable from './views/InvoiceTable/InvoiceTable';
...
const BillHistory = React.lazy(() => import('./views/InvoiceTable/InvoiceTable'))
...
const routes = [
  ...
  { path: '/BillHistory', name: 'BillHistory', element: BillHistory },
